...
# MAGIC The catalog `insurance_catalog_minnu` must be created via the Databricks UI BEFORE
...
# COMMAND ----------
# MAGIC %sql
CREATE CATALOG IF NOT EXISTS insurance_catalog_minnu MANAGED LOCATION 's3://databricks-storage-7474650621272587/unity-catalog/7474650621272587'
...
# will automatically use insurance_catalog_minnu.bronze, insurance_catalog_minnu.silver, etc.
...
# MAGIC CREATE VOLUME IF NOT EXISTS insurance_catalog_minnu.bronze.raw_data
# MAGIC COMMENT 'Raw landing-zone files for synthetic and public source data';

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE VOLUME IF NOT EXISTS insurance_catalog_minnu.bronze.checkpoints
...
# MAGIC SHOW SCHEMAS IN insurance_catalog_minnu;
