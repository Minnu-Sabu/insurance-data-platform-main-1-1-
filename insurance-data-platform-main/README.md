...
│   insurance_catalog_minnu.bronze  │  Metadata: _ingestion_timestamp,
...
│   insurance_catalog_minnu.silver  │  snake_case standardization
...
│   insurance_catalog_minnu.gold    │  8 Dimensions + 3 Facts
│                             │  + mart_policy_360
└─────────────────────────────┘
```
...
### 4. Query the Mart
```sql
SELECT * FROM insurance_catalog_minnu.gold.mart_policy_360
